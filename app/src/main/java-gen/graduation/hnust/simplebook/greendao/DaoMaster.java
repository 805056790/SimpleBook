...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        QQInfoModelDao.createTable(db, ifNotExists);
        QQTokenModelDao.createTable(db, ifNotExists);
        AccountRemindDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        QQInfoModelDao.dropTable(db, ifExists);
        QQTokenModelDao.dropTable(db, ifExists);
        AccountRemindDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(QQInfoModelDao.class);
        registerDaoClass(QQTokenModelDao.class);
        registerDaoClass(AccountRemindDao.class);
